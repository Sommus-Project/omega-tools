...
//               addError(`Exported function named '${prop.key.name}' was incorrectly declared inline`,'https://github.com/Sommus-Project/omega/blob/master/docs/lib/api.md#exported-functions');
//             }
//
//             return {
//               key: prop.key.name,
...
//     addError(`'module.exports' must exist as an object with one or more valid function.`,'https://github.com/Sommus-Project/omega/blob/master/docs/lib/api.md#exporteds');
//   }
//
//   exportedList.forEach(
//     info => {
//       if (!validFunctionNames.includes(info.key)) {
//         addError(`Invalid exported function named '${info.key}'`,'https://github.com/Sommus-Project/omega/blob/master/docs/lib/api.md#exported-functions');
//       }
//     }
//   );
//
...
//             addError(`The expected function signature for '${reqSignature}' was written incorrectly`,'https://github.com/Sommus-Project/omega/blob/master/docs/lib/api.md#api-functions');
//           }
//         }
//       }
//     );
